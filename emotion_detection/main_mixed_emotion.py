...
def run_emotion_analysis(text: str, model_name: str) -> Tuple[str, int]:
    command = [
        ...
        "run", model_name,
        f"""The input text contains complex and mixed emotions.
            Divide your answer into three section.
            First section is about defining the complex emotions in this text.
            The person will show combined emotions at once or show emotional progression in the text.
            In this section, identify the emotional progression of the person. 
            Put the header "Emotional Progression" before the section.
            Second section is about filling the gap between the emotions.
            In this section, first
             think about the detailed context of the emotions.
            Then provide the sufficient explanation of the context to fill the gap of the emotions or action they made.
            Put the header "Emotional Context" before the section.
            Third section is about guessing the past event which occured this event.
            Use the context and complex emotions you found in previous sections to guess the context.
            Put the header "Past Events" before the section.
            Text: {text}"""
    ]
...
if __name__ == "__main__":
    ...
    models = [
        ...
        "qwq",             # qwq model
        "llama3.1:405b"    # Llama 3.1 405B model
    ]
    ...
    df_all.to_csv("mixed_emotions_comparison.csv", index=False)
    print("\nCombined results saved to mixed_emotions_comparison.csv")
