...
def run_emotion_analysis(text: str, model_name: str) -> Tuple[str, int]:
    command = [
        ...
        f"""Analyze this text considering context, cultural nuances, and emotional complexity.
            Divide your answer into 4 different sections.
            First section talks about the primary emotion you get from the text. The format will be
            'Emotion: the emotion you found'
            Second section will be cultural nuances. After a header, talk about the cultural
            nuanaces you found. The format will be 'Cultural Nuances: the cultural nuances you found'
            Third section will be emotional complexity. Tell me about the secondary emotion or 
            other information about emotional complexity. 
            The format will be 'Emotional Complexity: the information related to emotional conplexity'
            Last section will be confidence level. Provide the confidence level about your result.
            The format will be 'Confidence Level: confidence level and reason'
            Text: {text}"""
    ]
...
if __name__ == "__main__":
    ...
    df_all.to_csv("emotion_results_comparison2.csv", index=False)
    print("\nCombined results saved to emotion_results_comparison2.csv")
